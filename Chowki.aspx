							...
							<div class="row">
								<div class="3u 12u(mobile)">
									...
									<!-- Sidebar -->
										<section>
											<header>
													<div style="text-align:center;"><img src="images/ganeshji.jpg" alt="" class="img-border">
											<p><strong>वक्रतुण्ड महाकाय सुर्यकोटि समप्रभ । <br />निर्विघ्नं कुरु मे देव सर्वकार्येषु सर्वदा ।।</strong></p>
                                            <img src="images/chowkiquotesm.jpg" alt="" class="img-border">
                                                    </div>
											</header>
										</section>
								</div>
                                  <div class="3u 12u(mobile)" style="text-align:center;">
                                        <section>
                                        <div>
                                        <img src="images/mataji.jpg" alt="" class="img-border" width="188px" height="148px">
                                        ...
                                        <section>
                                        <div>	
                                        <img src="images/chowki.jpg" alt="" class="img-border" width="188px" height="148px">
                                        ...
                                        <img src="images/chowki2.jpg" alt="" class="img-border" width="188px" height="120px" >
                                        </div>
                                        </section>
                                        </div>
                                        <div class="3u 12u(mobile)" style="text-align:center;">
                                        <section>
                                        <div>
                                        <img src="images/babaji.jpg" alt="" class="img-border" width="188px" height="148px">
					...
					<footer id="footer" class="container">
						<div class="row">
                            ...
                            <div class="4u 12u(mobile)">
								...
								<asp:Image ID="Image1" width="188px" height ="148px" style="cursor:pointer;"  runat="server" ImageUrl = "images/imgChowkiCard.jpg" onclick="DisplayNewImageInWidnow();" /> 
							</div>
						</div>
					</footer>
				</div>
